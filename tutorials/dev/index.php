...
$con=mysqli_connect("61b1ed95616f65903ff311cc9decad51aa4cac3d.rackspaceclouddb.com","vastdb","VastPlus#01","Yoda");
	if (isset($_GET['video_id']))
	  {
		$x = $_GET['video_id'];
		$result =  mysqli_query($con,"SELECT * FROM tutorials where vid=$x");
	  } 
	else
	{
...
<nav id="main-nav" class="top-bar" data-topbar>
  ...
  <section class="top-bar-section">
    <ul class="left">
      ...
      <li id="menu-2"><a href="http://plus.showseeker.com/guides/download.php?filename=ShowSeeker_Plus_Basic_User_Guide.pdf" target="_blank">Download User Guide</a></li>
    ...
    <div id="mainwrapper">
      <div id="ss-menu" class="container-content" style="overflow:hidden;">
        <?php 
        if (isset($x)) {
			$video_id = $rowx['video_link_id'];
			echo "<h2><u>Learning ShowSeeker Plus</u><br>". $rowx['video_title'] ."</h2>";
			echo "<iframe src='//player.vimeo.com/video/".$video_id."?title=0&amp;byline=0&amp;portrait=0' width='864' height='486' frameborder='0' webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>";
			echo "<h4 style='width:800px;'>". $rowx['video_text'] ." <br>Running Time: ". $rowx['video_length'] ." minutes.</h4>"; 
			}
		else {

			echo "<br><div class='row'>";
			echo "<div class='small-3 columns'><img style='width:250px;' src='../images/ss_logo.png'></div>";
			echo "<div class='small-9 columns'><h3>Welcome to the ShowSeeker Plus - Video Tutorials <br> Please select a tutorial below to view the video.</h3></div>";
			echo "</div><br>";
			include("title.php");
			}
		?>
