...
<div class="row">
        <div class="small-4 columns"><a href="play.php?id=1&userid=<?php echo $uid;?>" target="_blank" class="button radius">Training Module #1</a><br><a href="#" data-reveal-id="myModal1"><i class="fa fa-info-circle"></i> - Click Here for subjects covered in the video</a>

		</div>
        <div class="small-4 columns"><a href="play.php?id=2&userid=<?php echo $uid;?>" target="_blank" class="button radius">Training Module #2</a><br><a href="#" data-reveal-id="myModal2"><i class="fa fa-info-circle"></i> - Click Here for subjects covered in the video</a>

		</div>
        <div class="small-4 columns"><a href="play.php?id=3&userid=<?php echo $uid;?>" target="_blank" class="button radius">Training Module #3</a><br><a href="#" data-reveal-id="myModal3"><i class="fa fa-info-circle"></i> - Click Here for subjects covered in the video</a>
...
<div class="row">
	...
	<div class="small-2 columns">
			<a href="play.php?id=9&userid=<?php echo $uid;?>" target="_blank"><img src="images/tutorials_share1.png"><br><a href="#" data-reveal-id="myModal9"><i class="fa fa-info-circle"></i></a> - Copy, Rename, Merge & Share</a>
	</div>
</div>
</center>
<br>
<center>
<!-- div class="row">
		<div class="small-12 large-centered columns">Having troubles viewing the tutorials ? <br> Try our alternate location <a href="//showseeker.s3.amazonaws.com/tutorials/2016/index.htm">HERE</a></div>
</div -->
</center>
