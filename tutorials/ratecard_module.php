...
<nav id="main-nav" class="top-bar" data-topbar>
  ...
  <section class="top-bar-section">
    <ul class="left">
      ...
      <li id="menu-2"><a href="javascript:openTutorial();">Download User Guide</a></li>
    ...
    <div id="mainwrapper">
      <div id="ss-menu" class="container-content" style="overflow:hidden;">
        <?php 
			...
			echo "<div class='small-9 columns'><h6>Welcome to the ShowSeeker Plus - Rate Card Tutorial <br> If you have been assigned as the Rate Card Manager for your Market or Markets, this tutorial will guide you in how to edit current Rate Cards and create new Rate Cards.</h6></div>";
			echo "</div>";

			$con1 = mysqli_connect("db4.showseeker.net","vastdbuser","jK6YK71tJ","logs");
			$dtime = date('Y-m-d H:i:s');
			
			$sql = "INSERT INTO eventlogs (userid,eventslogid,request,result,createdat, updatedat) VALUES ('{$userid}', '56','Rate Card Tutorial','".$_SERVER['REMOTE_ADDR']."','{$dtime}','{$dtime}')";
...
<video width="850" height="500" controls><source src="//showseeker.s3.amazonaws.com/tutorials/ShowSeeker_Rate-Card-Manager.mp4" type="video/mp4">Your browser does not support the video tag.</video>
  ...
  <script>
	...
	function openTutorial(url){
		var w = 1024;
		var h = 880;
		var url  = 'http://showseeker.s3.amazonaws.com/tutorials/ShowSeeker_Rate_Card_Training_ModuleRev2.pdf';
	
	
		LeftPosition = (screen.width) ? (screen.width-w)/2 : 0;
		TopPosition  = (screen.height) ? (screen.height-h)/2 : 0;
		var tutorialWIndow   = window.open(url, "TUTORIAL", "location=no,status=yes,resizable=yes,scrollbars=yes,width="+w+",height="+h+",top="+TopPosition+",left="+LeftPosition);
