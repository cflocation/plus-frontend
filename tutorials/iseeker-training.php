...
<nav id="main-nav" class="top-bar" data-topbar>
  ...
  <section class="top-bar-section">
    <ul class="left">
      ...
      <li id="menu-2"><a href="http://plus.showseeker.com/guides/download.php?filename=ShowSeeker_iSeeker_Training_Manual_102414.pdf" target="_blank">Download User Guide</a></li>
    ...
    <div id="mainwrapper">
      <div id="ss-menu" class="container-content" style="overflow:hidden;">
        <?php 
			...
			echo "<h2><u>ShowSeeker - iSeeker Training</h2>";
			echo '<video width="850" height="500" controls><source src="https://showseeker.s3.amazonaws.com/tutorials/ShowSeeker_iSeeker_Training_110714.mp4" type="video/mp4">Your browser does not support the video tag.</video>';

			echo "<h4 style='width:800px;'>ShowSeeker - iSeeker Training<br>Running Time: 25 minutes.</h4>"; 

			$con1 = mysqli_connect("db4.showseeker.net","vastdbuser","jK6YK71tJ","logs");
			$dtime = date('Y-m-d H:i:s');
			
			$sql = "INSERT INTO eventlogs (userid,eventslogid,request,result,createdat, updatedat) VALUES ('{$userid}', '56','iSeeker Training','".$_SERVER['REMOTE_ADDR']."','{$dtime}','{$dtime}')";
