...
function saveChangePassword(){
    ...
    $.ajax({
        type:'post',
        url: "https://apistg2.showseeker.com/user/passwordreset/reset",
        dataType:"json",
        processData: false,
...
function externalResetPassword(){
	...
	if(newPassword !== ''){	    
		...
		var apiUrl = "https://apistg2.showseeker.com/user/passwordreset/changepassword";
		$.ajax({
			type:'post',
			url: apiUrl,
			dataType:"json",
...
function sendToken(){
    ...
    $.ajax({
        type:'post',
        url: "https://apistg2.showseeker.com/user/passwordreset/sendlink",
        dataType:"json",
        processData: false,
        contentType: 'application/json',
        data: JSON.stringify(data),
...
function verifyToken(){    
    ...
    $.ajax({
        type:'post',
        url: "https://apistg2.showseeker.com/user/passwordreset/verifytoken",
        dataType:"json",
        processData: false,
        contentType: 'application/json',
        data: JSON.stringify(data),
