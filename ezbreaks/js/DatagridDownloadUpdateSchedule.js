...
function DatagridDownloadUpdateSchedule() {
    var grid;
    var data = [];
    var dataView;
    var selectedRows = [];
    ...
    grid = new Slick.Grid("#datagrid-download-update-scheduler", dataView, columns, options);
