<?php
	...
	$sql = "SELECT * FROM ratecard_card_versions WHERE ratecardid = $cardid AND working = 1";
	...
	$sql = "UPDATE ratecard_card_versions SET working = 0, updatedat = '$d' WHERE id = $id";
	$result = mysql_query($sql);

	//inset a clone of the current record
	$sql = "INSERT INTO ratecard_card_versions (ratecardid, working, ratecard, userid, createdat, updatedat) VALUES ($ratecardid,1,'$ratecard',$userid,'$d','$d')";
	$result = mysql_query($sql);
	//get the new id
