...
function schedulerAddLineToProposal(close) {
	...
	var xurl = "http://ww2.showseeker.com/plus/services/weeks.php?callback=?&start=" + starts + "&end=" + ends + "";
...
function addShowToProposalFromID(id) {
	var zrl = 'http://10.15.10.102:8983/solr/gracenote/select/?q=*%3A*&version=2.2&start=0&indent=on&json.wrf=?&wt=json';
	zrl += "&fq=id:" + id;
