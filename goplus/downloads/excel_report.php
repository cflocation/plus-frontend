...
$proposalName = str_replace(" ",".",strtolower(preg_replace('/[^\w\s]+/u','' ,urldecode($proposalLines['proposalinfo']['name'])))).".xls";
...
$excelLocation = str_replace('excel_report.php', '../../showseeker/files/tmp/', __FILE__);
$objWriter->save($excelLocation.$proposalName);




// Download file
$re = array("filename"=>$proposalName);
echo json_encode($re);
