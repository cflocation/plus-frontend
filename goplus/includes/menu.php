...
<ul class="sf-menu">
		...
		<ul style="margin-left:-100px;">
			...
			<li class="package-menu">
				...
				<ul style="margin-left:-350px!important;">
					...
					<li class="package-menu" ><a href="services/fdownload.php?filename=http://showseeker.s3.amazonaws.com/tutorials/manuals/SnapShot_User_Guide.pdf" id="snapshot-manual" style="display:none;" target="_blank" onclick="mixTrack('Tutorials - Snapshot');">SnapShot</a></li>
			...
			<li class="package-menu"><a href="javascript:openBroadcasrtCalendar();" onclick="mixTrack('Help - BroadcastCalendar');">Broadcast Calendar</a></li>			
	...
	<li style="background-color: #333333;">
		...
		<ul style="margin-left:-135px!important;">
			...
			<li class="package-menu"><a href="javascript:dialogEzGrids()" style="display:none;" id="ezgridsLink" onclick="mixTrack('EzGrids-Zips')"> E-z Grids</a></li>
