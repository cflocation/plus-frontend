...
<ul class="sf-menu">
		...
		<ul style="margin-left:-100px;">
			<li class="package-menu">
				...
				<ul style="margin-left:-350px!important;">
					<li class="package-menu"><a href="javascript:void(0)" onclick="openTutorial('http://ww3.showseeker.com/tutorials/?v=2',true); mixTrack('Tutorials - Full Basic Training'); return false;" >Full Basic Training Modules</a></li>
					<li class="package-menu">
						<a href="javascript:void(0)">Mini Modules</a>
						<ul style="margin-left:-295px!important;">
							<li class="package-menu"><a href="javascript:void(0)" onclick="openTutorial('http://ww3.showseeker.com/tutorials/play.php?id=7',true); mixTrack('Tutorials - Title & Keyword Search'); return false;">Title & Keyword Search</a></li>
							<li class="package-menu"><a href="javascript:void(0)" onclick="openTutorial('http://ww3.showseeker.com/tutorials/play.php?id=6',true); mixTrack('Tutorials - Rotators & Avails'); return false;">Rotators & Avails</a></li>
							<li class="package-menu"><a href="javascript:void(0)" onclick="openTutorial('http://ww3.showseeker.com/tutorials/play.php?id=4',true); mixTrack('Tutorials - Ez Grids'); return false;">E-z Grids</a></li>
							<li class="package-menu"><a href="javascript:void(0)" onclick="openTutorial('http://ww3.showseeker.com/tutorials/play.php?id=5',true); mixTrack('Tutorials - Projected Calendar'); return false;">Projected Calendar</a></li>
							<li class="package-menu"><a href="javascript:void(0)" onclick="openTutorial('http://ww3.showseeker.com/tutorials/play.php?id=8',true); mixTrack('Tutorials - Help & Tutorials'); return false;">Help & Tutorials</a></li>
							<li class="package-menu"><a href="javascript:void(0)" onclick="openTutorial('http://ww3.showseeker.com/tutorials/play.php?id=9',true); mixTrack('Tutorials - Copy, Rename'); return false;">Copy, Rename, Merge & Share</a></li>
						</ul>
					</li>
					<li class="package-menu"><a href="javascript:void(0)" onclick="openTutorial('http://ww3.showseeker.com/tutorials/training-refresher.php?v=2',true); mixTrack('Tutorials - Refresher'); return false;" target="_blank">ShowSeeker PLUS Refresher</a></li>
					<li class="package-menu"><a href="javascript:void(0)" onclick="openTutorial('http://www.showseeker.com/tutorials/ratecard_module.php?v=2',true); mixTrack('Tutorials - Rate Card'); return false;" id="ratecard-access-btn" target="_blank">Rate Card Module</a></li>
				</ul>			
			</li>
			<li class="package-menu">
				<a href="javascript:void(0)">User Guides</a>
				<ul style="margin-left:-350px!important;">
					<li class="package-menu"><a href="javascript:void(0)" onclick="openTutorial('includes/guides/userguides/ShowSeekerUserGuide02032017.pdf');">Full Basic User Guide</a></li>
					...
					<li class="package-menu"><a href="includes/guides/download.php?filename=adsails_import.pdf" onclick="mixTrack('Tutorials - Adsails Guide');">Adsails Import Guide</a></li>
					<li class="package-menu" ><a href="includes/guides/download.php?filename=SnapShotInstructions2017.pdf" id="snapshot-manual" style="display:none;" target="_blank" onclick="mixTrack('Tutorials - Snapshot');">SnapShot <span style="color: lime;"><i>New</i></span></a></li>
					<li class="package-menu"><a href="includes/guides/download.php?filename=ShowSeeker_Rate_Card_Training_ModuleRev2.pdf" id="rate-card-manual" onclick="mixTrack('Tutorials - Rate Card Administration');">Rate Card Administration Guide</a></li>
				</ul>
			</li>
	...
	<li style="background-color: #333333;">
		...
		<ul style="margin-left:-135px!important;">
			<!-- li class="package-menu"><a href="/goplus"> ShowSeeker Plus</a></li -->
			<li class="package-menu"><a href="/snapshotalpha" style="display:none;" id="snapshotLink"> SnapShot</a></li>
			<li class="package-menu"><a href="/ezrates" style="display:none;" id="rcmLink"> Rate Card Manager</a></li>
			<li class="package-menu"><a href="/packagebuilder" style="display:none;" id="customPackageBuilderLink" target="winCustomPackageTool"> Custom Package Builder</a></li>
