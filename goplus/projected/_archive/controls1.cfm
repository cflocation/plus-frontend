...
<cfset thesepropsoals = CreateObject('component', 'cfc.index').proposalsjson(userid='#userid#',isJSON='NO')>
...
<div class="topheader" style="width:100%;">
		...
		<div class="innercontrols" id="ctlproposal" style="width:auto;">
			...
			<select class="filters"   id="proposalList" name="proposalList">
				<option value="">
				<cfoutput query="thesepropsoals">
				<option value="#thesepropsoals.id#">#URLDecode(thesepropsoals.name)#</option>
				</cfoutput>
			</select>
		</div>
...
<div class="topheader2" style="width:100%;">
	...
	<div class="innerparams" style="background-color:##3D003D; color:##fff;">
		Zone
		<cfselect query="zones" id="zones" name="zones" selected="#Trim(zoneid)#" display="ZONENAME" value="ZONEID" class="filters"></cfselect>
	</div>  
	...
	<!-- div class="separator" style="width:60px;">&nbsp;</div -->
	<!-- span class="update" id="updategrid" style="padding: 4px; border: solid 1px ##FF0000">Update Calendar</span -->
