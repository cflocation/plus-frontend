  <center>
   	...
   	<input type="checkbox" id="checkbox-publish-ratecard" value="yes"><label for="checkbox-publish-ratecard">I want to publish the selected ratecards</label>
    	<br>
    ...
    <div data-alert class="alert-box red_alert radius">
      <i class="fa fa-exclamation-triangle fa-lg"></i> Clicking publish will make your ratecard live.
    	...
    	<button onclick="publishRatecardGroupEvent();" class="tiny green"><img src="/images/tiny-s.png"> Publish</button>
