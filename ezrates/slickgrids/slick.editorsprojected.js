...
(function ($) {
  ...
  $.extend(true, window, {
    "Slick": {
      "Editors": {
        ...
        "NetworkSelector": NetworkSelectorEditor,
  ...
  function NetworkSelectorEditor(args) {
    var $select;
    var defaultValue;
    var scope = this;

    this.init = function () {
      $select = $("<SELECT tabIndex='0' class='editor-yesno'><OPTION value='yes'>ggggg</OPTION><OPTION value='no'>hhhhh</OPTION></SELECT>");
  ...
  function LongTextEditor(args) {
    ...
    this.init = function () {
      ...
      $("<DIV style='text-align:right'><input type='checkbox' id='cbchangeall' checked='checked' onclick='dataGrid.setCheckbox();' name='changeall' value=1>Changa All Values<BUTTON>Save</BUTTON><BUTTON>Cancel</BUTTON></DIV>")
          .appendTo($wrapper);
