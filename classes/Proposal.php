<?php
	class Proposal{
		...
		public function getproposals(){
			...
			proposals.grossttl as netttl, 
			proposals.netttl as net, 
			proposals.amount,
		...
		//create proposal
		public function createproposals($proposal, $weeks, $name, $calendar){
			$proposal = $this->con->real_escape_string($proposal);
			$sql = "INSERT INTO proposals (userid, name, proposal, weeks, calendar, createdat, updatedat)VALUES ($this->userid, '$name','$proposal','$weeks','$calendar','$this->now','$this->now')";
			$result = mysqli_query($this->con, $sql);
