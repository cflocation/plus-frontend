<?php
	class On{
		...
		public function getImageSizeShowID($showid){
			...
			$sql = "SELECT * FROM onGalleryImages WHERE TMSId = '$showid' AND action != 'delete' AND process = 1 GROUP BY width, height ORDER BY lastModified";
		...
		public function getOnData($showid){
			...
			$sql = "SELECT * FROM onGalleryImages WHERE TMSId = '$showid' AND action != 'delete'";
