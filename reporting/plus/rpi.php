<?php
	...
	$proposal_sql = "SELECT id, userid, proposal, createdat from proposals order by createdat desc limit 0, 50"; 
...
<head>
<title>ShowSeeker - Rotator Package Inspector</title>
...
<div class="row">
	<table align="center"><tr valign="top"><td>
			<thead>
				<tr>
				<th><center>Proposals with Rotators</center></th>
				</tr>
			  </thead>
			<tbody>
				<?php
