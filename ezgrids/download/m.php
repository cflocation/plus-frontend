...
$folderPath1a = "grids/2015/xlsx/ast/".$correctMonday."/";
...
//AST
$arr1a = S3::getBucket($bucketName,$folderPath1a);
	foreach ($arr1a as &$value) {
		...
		$locafile = '/var/www/html/showseeker.com/ezgrids/download/ast/xlsx/'.$localfilename;
