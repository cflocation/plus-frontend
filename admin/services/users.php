<?php
	...
	if($eventtype == "create"){
		...
		$sql = "INSERT INTO User (apiKey, corporationId, firstName, lastName, title, email, phone, fax, mobile, active, createdAt, updatedAt,initials) VALUES ('$uuid', $corporationid, '$firstname', '$lastname', '$title', '$email', '$phone', '$fax', '$cell', $active, '$d', '$d','$initials')";
		mysql_query($sql);
