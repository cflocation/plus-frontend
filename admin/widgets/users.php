<?php
	...
	if(isset($marketid) && $marketid){
		$thisRegionId = $marketid;
	}
	if(isset($officeId) && $officeId){
		$thisOfficeId = $officeId;
	}    
?>
...
<div data-role="collapsible"  data-collapsed="true" id="usersWidget">
	...
	<div>			
		...
		<a href="user.php?id=0&corpId=<?php print $corpId; ?>&region=<?php print $thisRegionId; ?>&officeid=<?php print $thisOfficeId ?>" rel="external" data-mini="true" data-role="button"  data-inline="true">
	...
	<br/>
	<input type="search" id="filterUsersInput" placeholder="Filter Users ...">
	<ul id="usersListWidget" data-role="listview" data-inset="true" data-dom-cache="false" data-cache="false"> 
		<?php 			
		while ($row = mysql_fetch_assoc($result)): ?>
			<li id=<?php print($row['userid'])?> class="allUsersList">
				...
				<a style="position:relative; left:40px;" rel="external" href="user.php?id=<?php print $row['userid'];?>&corpId=<?php print $corpId;?>&region=<?php print $thisRegionId;?>&officeid=<?php print $thisOfficeId;?>">
